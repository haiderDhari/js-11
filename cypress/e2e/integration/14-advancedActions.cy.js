...
describe("Keyboard & Mouse Actions", () => {
  ...
  */
      ...
      /* الحل الاول 
    cy.get('#click').should('have.text', 'Click on me').click()
    cy.get('#click_result').should('have.text', 'You clicked on a button!')

    cy.get('#right-click').should('have.text', 'Right-Click on me').rightclick()
    cy.get('#right_click_result').should('have.text', 'You right-clicked on a button!')

    cy.get('#double-click').should('have.text', 'Double-Click on me').dblclick()
